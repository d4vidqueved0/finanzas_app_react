...
export function CardRegistro({ registro }: { registro: RegistroTypeDB }) {
  return (
    <Card
    ...
    >
      <div>
        <div className="flex gap-2 items-center mt-3">
          <h3 className="font-bold text-2xl capitalize line-clamp-1">{registro.titulo}</h3>
      ...
      <span className="text-lg font-semibold truncate max-w-24">
